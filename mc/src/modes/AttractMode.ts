...
class AttractMode extends Mode {
    ...
    init() {
        ...
        this._backgroundLayer = this._dmd.createCanvasLayer(
            'attract-background',
            {},
            new Options({
                visible : false,
            ...
            (layer: CanvasLayer) => {
                that._resourcesManager
                    ...
                    .load()
                    .then(bitmap => {
                        layer.drawBitmap(bitmap, new Options({
                            width: '100%',
                            height: '100%'
                        }))
                    })
        ...
        this._titleLayer1 = this._dmd.createTextLayer(
            'attract-title1',
            {},
            new Options({
                text :  'SCOTT',
        ...
        this._titleLayer2 = this._dmd.createTextLayer(
            'attract-title2',
            {},
            new Options({
                text : 'PILGRIM',
        ...
        this._subTitleLayer = this._dmd.createTextLayer(
            'attract-subtitle',
            {},
            new Options({
                text : 'VS. THE WORLD',
        ...
        this._startLayer = this._dmd.createTextLayer(
            'attract-start',
            {},
            new Options({
                text : startString,
        ...
        this._creditsLayer = this._dmd.createTextLayer(
            'attract-credits',
            {
                width : 48,
                height : 6,
        ...
        this._gameOverBackgroundLayer = this._dmd.createCanvasLayer(
            'gameover-bg',
            {},
            new Options({
                visible : false
        ...
        this._gameOverTextLayer = this._dmd.createTextLayer(
            'gameover-text',
            {},
            new Options({
                text : goString,
